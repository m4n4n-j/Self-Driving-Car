...
# move : implementing vehicle movement and defining the sand detection via sensors.
    def move(self, rotation):
        ...
        #!Updating sensors position
        self.sensor1 = Vector(30, 0).rotate(self.angle) + self.pos
        self.sensor2 = Vector(30, 0).rotate((self.angle+30)%360) + self.pos
        self.sensor3 = Vector(30, 0).rotate((self.angle-30)%360) + self.pos
        #Calculating new signals (Based on density of sand)
        self.signal1 = int(np.sum(sand[int(self.sensor1_x)-10:int(self.sensor1_x)+10, int(self.sensor1_y)-10:int(self.sensor1_y)+10]))/400.
        self.signal2 = int(np.sum(sand[int(self.sensor2_x)-10:int(self.sensor2_x)+10, int(self.sensor2_y)-10:int(self.sensor2_y)+10]))/400.
        self.signal3 = int(np.sum(sand[int(self.sensor3_x)-10:int(self.sensor3_x)+10, int(self.sensor3_y)-10:int(self.sensor3_y)+10]))/400.
        #Heavy penalizing for reaching/colliding the edges of enviornment
...
class Game(Widget):
    ...
    def update(self, dt):
        ...
        if sand[int(self.car.x),int(self.car.y)] > 0:
            ...
            self.car.velocity = Vector(7, 0).rotate(self.car.angle)
            last_reward = -0.4
